    ...
    if(hasMobileVersion &amp;&amp; !isBelowIE8()){
    	var pageIndex=getURLParam('pageIndex');
		  if(!pageIndex){
			...
			document.write("Sorry,need flash player. <a href="http://www.adobe.com/go/getflashplayer">Get Adobe Flash Player&lt;\/a&gt; it's possible to </a><a id="linkSEO" href="files/basic-html/index.html">view a simplified version of the book on any device</a>, or you can view the mobile version <a href="mobile/index.html"> here </a>" ); 
		} 
    return false; 
  }  
};
